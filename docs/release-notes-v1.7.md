...
```
文件：YiYou-Setup.exe
大小：92,375,468 字节（88.1 MB）
SHA256：887395fe2e54306e7eb42363cadc978850c16872c0b2666fdb21a6e6ba97e4c2
构建：2026-09-20（v1.7.7）；库内 44 条题链、1,124 道题（1,079 道古典死活题）
实测：测试目录安装成功；首启自动导入 44 链 + 1,124 题（schema v11）；
自检 v1.7.7；引擎可用（GPU 忙时自动回退 CPU）
```
